...
it('renders the element', function () {
    ...
    © 2021 QuantaQuirk. All rights reserved.';
...
'.str_repeat(' ', 44).'
    ...
    QuantaQuirk'.str_repeat(' ', 33).'
'.str_repeat(' ', 44).'
    © 2021 QuantaQuirk. All rights reserved.'.str_repeat(' ', 3)
    );
});
...
<bg=blue;fg=red;options=bold>\e[3m    QuantaQuirk                                 \e[0m</>
<bg=blue;fg=red;options=bold>\e[3m                                            \e[0m</>
<bg=blue;fg=red;options=bold>\e[3m    © 2021 QuantaQuirk. All rights reserved.   \e[0m</>");
});
